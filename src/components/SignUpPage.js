    ...
    <div className="login-container">
      <div className="signup-content">
        <div className="login-form">
          <h2 style={{color:" #644860",}}>Create your account</h2>
          ...
          <form onSubmit={handleSignup} >
           ...
           <div className="form-groupLog phone-input">
          ...
          <button type="submit" style={{backgroundColor:" #644860"}}>Sign Up</button><br/><br/>
          Already have a account? <Link to='/login' style={{color:" #644860", textDecoration:"none", fontSize: "15px"}}>Login</Link>
          </form>
        </div>
        <div className="sign-image">
          <img src="https://coolaiid.com/blog/images/retro-future.png"alt="Login" />
        </div>
      </div>
    </div>
    </div>
